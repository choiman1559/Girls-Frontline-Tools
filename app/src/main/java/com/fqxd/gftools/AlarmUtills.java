...
public class AlarmUtills {
    ...
    void repeat(SharedPreferences sharedPreferences,Context context,int count){
    ...
    void cancel(SharedPreferences sharedPreferences,Context context,int count) {
        PackageManager pm = context.getPackageManager();
        Intent intent = new Intent(context,AlarmReceiver.class);
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context,count,intent,PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    void editSharedPrefs(SharedPreferences sharedPreferences,int H,int M, Calendar calendar,String Package,String name,Context context) {
