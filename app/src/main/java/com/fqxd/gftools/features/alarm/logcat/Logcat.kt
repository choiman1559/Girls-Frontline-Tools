...
import com.fqxd.gftools.features.alarm.logcat.logger.Logger
import com.fqxd.gftools.features.alarm.logcat.collections.FixedCircularArray
import java.io.*
import java.util.*
...
class Logcat(initialCapacity: Int = INITIAL_LOG_CAPACITY) : Closeable {
    ...
    private fun postLogsPeriodically() {
        while (isProcessAlive) {
            ...
            //TODO: check this lines how works
            /*
